            ...
            <div className="max-w-md w-full bg-white/90 rounded-2xl shadow-xl border border-white/40 p-8 flex flex-col items-center">
                ...
                <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4 mt-4">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-400 text-white font-semibold py-3 rounded-lg shadow transition-colors text-lg mt-2"
                    >
